...
public class VisionConstants {
    public static final Transform3d robotToBLATCamera = new Transform3d(new Translation3d(-0.3048,0.216,0.2667),new Rotation3d(0,Units.degreesToRadians(-10),Units.degreesToRadians(230)));
    public static final Transform3d robotToBRATCamera = new Transform3d(new Translation3d(-0.3048,-0.216,0.2667),new Rotation3d(0,Units.degreesToRadians(-10),Units.degreesToRadians(-230)));
